...
import yedu.witworks.com.bluetoothcamera.manage.ManagingThread;

/**
 * Created by yedunath on 27/4/16.
 */
public class TransmitterConnectService {
    private int count = 0;
    ...
    public TransmitterConnectService(Context mContext, Handler mHandler) {
    ...
    public void sendData() {
        if (mManagingThread != null) {
            Log.d("OUT", mManagingThread.deviceName + "test");
